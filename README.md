...
Klomimory is a lightweight, active recall and flashcard study plugin for Obsidian. It allows you to transform simple markdown lists and vocabulary notes into interactive study sessions with SRS-like queues, custom direction controls, and statistics tracking.
✨ Features
